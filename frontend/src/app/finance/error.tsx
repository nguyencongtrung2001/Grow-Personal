...
/**
 * Finance Route — Error Boundary Segment.
 */
export default function FinanceError({ error, reset }: ErrorBoundaryProps) {
  useEffect(() => {
  ...
  return (
    ...
    >
      <div className="max-w-md w-full text-center space-y-6">
        <div className="mx-auto w-14 h-14 rounded-2xl bg-amber-50 border border-amber-100 flex items-center justify-center shadow-sm">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-500 leading-relaxed">
            Your financial pots and transaction data couldn&apos;t be loaded.
