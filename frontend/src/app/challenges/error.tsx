...
/**
 * Challenges Route — Error Boundary Segment.
 */
export default function ChallengesError({ error, reset }: ErrorBoundaryProps) {
  useEffect(() => {
    console.error("[Challenges Error Boundary]", error);
  }, [error]);
  ...
  return (
    ...
    >
      <div className="max-w-md w-full text-center space-y-6">
        <div className="mx-auto w-14 h-14 rounded-2xl bg-orange-50 border border-orange-100 flex items-center justify-center shadow-sm">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-500 leading-relaxed">
            Your challenge progress and milestones couldn&apos;t be loaded.
            All streak data is safely stored.
          </p>
          {error.digest && (
